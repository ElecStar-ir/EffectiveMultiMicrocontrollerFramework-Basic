...
#include "EMF.h"
    ...
    bool _Delay_configState_1Ok_0NotConfiged = false;
//=========================================================================================
//=========================================================================================
    bool EMF_Delay_L1_Config_return_0Error_1Ok(TIM_TypeDef *SelectTimerToCreateDelay_Ptr__Ex_TIM1){

        EMF_Delay_Lx_Timer_Stop();
        _Delay_configState_1Ok_0NotConfiged = 0;
        ...
        if (_htimx.Instance->CR1 & 0b1) {  // if CR1.B0(CEN) == 1 =>Counter Enabled
            ...
            if (((_Tick_B - _Tick_A) / 10) == 1){
                _Delay_configState_1Ok_0NotConfiged = true;
                return 1; //OK
            }
...
//=========================================================================================
    void EMF_Delay_Lx_Timer_Stop() {
        if (_htimx.Instance != 0) {  // pointer Is Not null?
            ...
            _Delay_configState_1Ok_0NotConfiged = false;
        }
    }
//=========================================================================================
//=========================================================================================
...
//=========================================================================================
    bool EMF_Delay_Lx_ConfigState_Return_1Ok_0NotConfiged() {
        return _Delay_configState_1Ok_0NotConfiged;
    }
//=========================================================================================
//=========================================================================================
    uint32 EMF_Delay_L2_Get_WhileDelayCount(int16 Delay_us_0to32767){
        if(EMF_Delay_Lx_ConfigState_Return_1Ok_0NotConfiged() == 0){return 0;}
